...
df_control = pd.read_excel('D:/data/native_protein_digestion/12072021/control/atom_spearman_10_240min.xlsx',index_col=0).dropna()
...
df_control = df_control[df_control['spearman correlation']!=0]
#
...
fig,ax = plt.subplots()
# sns.scatterplot(data=df_control,x='blast_identity',y='plddt', hue='significant_-spearman',
#                 alpha=0.6,palette='Set2')
# ax.boxplot([df_control['blast_identity'].values,
#                        df_control[df_control['significant_-spearman']==1]['blast_identity'].values])
# sns.violinplot(data=df_control, x='significant_-spearman',y='blast_identity')
