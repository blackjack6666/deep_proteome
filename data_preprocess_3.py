...
if __name__=='__main__':
    ...
    peptide_tsv_path = "D:/data/deep_proteome/non_specfic_search/ct_24h/peptide.tsv"
    ...
    ppp.dump(polymer_label_dict, open('D:/data/deep_proteome/non_specfic_search/ct_24h_15mer.p', 'wb'))
